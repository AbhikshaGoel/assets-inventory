      ...
      <Dialog open={open} onClose={toggleDialog}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Kindly select the category and subcategory of the asset, provide name and quantity, and choose whether it's a fresh request or buy back against stale or broken items. Click save when you're done.
            </DialogDescription>
          </DialogHeader>
